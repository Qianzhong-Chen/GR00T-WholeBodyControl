...
class UnitreeSdk2Bridge:
    ...
    def __init__(self, config):
        ...
        # Create the command locks BEFORE registering subscribers. The deploy
        # node may already be publishing rt/lowcmd and rt/dex3/*/cmd, so a
        # handler thread can fire the instant .Init() runs — before these locks
        # exist — raising AttributeError. Initialize them first to avoid the race.
